...
// Textfields
Widget authTextFormField(String? text, String hintText, bool isPassword, TextEditingController controller, Function validatorFunction) {
  return Container(
...
Widget textFormField(String? text, String hintText, TextEditingController controller, Function validatorFunction, {TextInputType? keyboardType}) {
  return Container(
    alignment: Alignment.bottomLeft,
