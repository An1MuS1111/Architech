...
class _OrderTrackingState extends State<OrderTracking> {
  ...
  static const LatLng destination =
      LatLng(1.5577654908351668, 103.64254923843006);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      children: [
        ...
        Positioned(
            top: 40, left: 30, child: appLogo("assets/logo_small.png", 150)),
        Positioned(
          bottom: 10,
          width: width,
          child: Container(
            ...
            decoration: BoxDecoration(
                color: semanticBlue, borderRadius: BorderRadius.circular(20)),
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Text("Parcel 1", style: TextStyle(fontSize: 16)),
                    Text("In transit at Lingkaran Ilmu",
